...
public class ManagementModel {
     ...
     */
    public static List<Invoice> findInvoicesByPeriod(Period period) throws SQLException, IOException, ClassNotFoundException {
        checkConnection();
        ...
        try(PreparedStatement stm = con.prepareStatement(sql)) {
            ...
            try(ResultSet rs = stm.executeQuery()) {
                while(rs.next()) {
                    ...
                    invoice.setSeller(loadSellerById(rs.getInt("sel_id")));
                    result.add(invoice);
                }
            }
        }
     ...
     */
    public static Invoice loadInvoiceById(int id) throws SQLException, IOException, ClassNotFoundException {
        checkConnection();
        ...
        try(PreparedStatement stm = con.prepareStatement(sql)) {
            ...
            try(ResultSet rs = stm.executeQuery()) {
                ...
                result.setSeller(loadSellerById(rs.getInt("sel_id")));
                result.setListLines(loadLinesInvoice(result));
                return result;
            }
        }
    }
     ...
     */
    private static Seller loadSellerById(int id) throws SQLException, IOException, ClassNotFoundException {
        checkConnection();
     ...
     */
    public static List<Seller> getAllSellers() throws SQLException, IOException, ClassNotFoundException {
        checkConnection();
     ...
     * */
    private static List<LineInvoice> loadLinesInvoice(Invoice invoice) throws SQLException, IOException, ClassNotFoundException {
        checkConnection();
     ...
     * */
    public static void saveNewInvoice(Invoice newInvoice) throws SQLException, IOException, ClassNotFoundException {
        checkConnection();
     ...
     * */
    public static void updateInvoice(Invoice invoice) throws SQLException, IOException, ClassNotFoundException {
        checkConnection();
        ...
        try(PreparedStatement stm = con.prepareStatement(sql)) {
            ...
            stm.executeUpdate();
            deleteLinesInvoice(invoice);
            saveLinesInvoice(invoice);
        }
    }
     ...
     * */
    public static void deleteInvoice(Invoice invoice) throws SQLException, IOException, ClassNotFoundException {
        checkConnection();
     ...
     * */
    private static void saveLinesInvoice(Invoice invoice) throws SQLException, IOException, ClassNotFoundException {
        checkConnection();
     ...
     * */
    private static void deleteLinesInvoice(Invoice invoice) throws SQLException, IOException, ClassNotFoundException {
        checkConnection();
    ...
    /**
     * Метод проверяет наличие соединения с базой данных,
     * в случае отсутствия соединения - происходит попытка его установить и получить на него ссылку
     */
    private static void checkConnection() throws SQLException, IOException, ClassNotFoundException {
        if (con == null)
